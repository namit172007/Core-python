...
class FacultyService:
    ...
    def save(self, obj):
        ...
        if duplicate.exists():
            raise Exception('Faculty already exist')
    ...
    def find_by_login(self, email):
        print('Faculty service orm find_by_login()')
        obj = Faculty.objects.filter(email=email)
        return obj

    def authenticate(self, email, password):
        print('Faculty service orm authenticate()')
