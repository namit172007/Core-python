...
class CollegeService:
    ...
    def save(self, obj):
        print('college service orm save()')
    ...
    def delete(self, id):
        print('college service orm delete()')
        obj = self.get(id)
        obj.delete()

    def find_by_name(self, name):
        print('college service orm find_by_name()')
        obj = College.objects.filter(name=name)
        return obj

    def search(self, params):
        print('college service orm search()')
